...
# 在 Windows 上使用 SelectorEventLoop 以兼容 psycopg
...
if __name__ == "__main__":
    ...
    if sys.platform == 'win32':
        # 在 Windows 上使用 SelectorEventLoop 避免 psycopg 兼容性问题
        asyncio.run(run_server(), loop_factory=asyncio.SelectorEventLoop)
    else:
